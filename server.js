...
// ============================================
app.use(cors({
  origin: ["https://rhms-frontend-blush.vercel.app"],
...
// ============================================
// FIREBASE ADMIN - SINGLE CORRECT INITIALIZATION
// ============================================
...
try {
    ...
    if (serviceAccount) {
        ...
        console.log('⚠️ Firebase not configured - email features will be simulated');
    }
} catch (error) {
...
setInterval(() => {
    ...
    console.log(`🧹 2FA Sessions cleaned. Active: ${tempLoginSessions.size}`);
}, 5 * 60 * 1000);
